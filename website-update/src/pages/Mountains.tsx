  ...
  <div ref={root} className="alpine-page" data-stage={activeStop}>
    ...
    <main id="alpine-main" tabIndex={-1}>
      ...
      <section id="summit" className="alpine-stage alpine-summit" aria-labelledby="summit-title" tabIndex={-1}>
        ...
        <footer className="alpine-footer"><span>© {new Date().getFullYear()} Mihir Patel</span><a href="/">Compare with original <ArrowUpRight size={14} aria-hidden="true" /></a><a href="#basecamp">Back to basecamp ↑</a></footer>
      </section>
    </main>
  </div>
  );
